...
function Header() {
  return (
    <div className="text-lg absolute top-0 z-10 w-full">
        ...
        <div className="mx-auto w-full px-2 md:px-6 lg:px-8">
          <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-shrink-0 items-center rounded-full overflow-hidden lg:mr-3">
                <Link to="/">
                  <img
                    alt="Your Company"
                    src={LOGO}
                    className="h-14 ml-16 md:ml-0 md:h-12 w-auto cursor-pointer hover:scale-125 transition ease-out duration-500"
                  />
                </Link>
              </div>
            ...
            <div className="flex gap-x-3 xl:gap-x-5">
              <FaFacebook className="text-3xl lg:text-3xl cursor-pointer text-[#405DE6] hover:scale-110 transition ease-out duration-300" />
              <FaSquareInstagram className="text-3xl lg:text-3xl cursor-pointer text-[#E1306C] hover:scale-110 transition ease-out duration-300" />
              <FaTwitter className="text-3xl lg:text-3xl cursor-pointer text-[#1DA1F2] hover:scale-110 transition ease-out duration-300" />
            </div>
          </div>
        </div>
